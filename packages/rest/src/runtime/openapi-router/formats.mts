...
export const int32: Ajv.Format = { type: "number", validate: validateInt32 };
// signed 64 bit integer
export const int64: Ajv.Format = { type: "number", validate: validateInt64 };
// C-type float
export const float: Ajv.Format = { type: "number", validate: validateNumber };
// C-type double
export const double: Ajv.Format = { type: "number", validate: validateNumber };
...
export function addFormatsAjv(ajv: Ajv.default): Ajv.default {

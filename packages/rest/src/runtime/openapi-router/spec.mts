...
export declare namespace OpenAPIV3 {
    ...
    type SchemaObject = BaseSchemaObject;
    interface BaseSchemaObject extends Exclude<JSONSchema, boolean> {
        title?: string;
        description?: string;
        format?: string;
        default?: any;
...
export declare namespace OpenAPIV2 {
    ...
    interface SchemaObject extends Exclude<JSONSchema, boolean> {
        [index: string]: any;

...
export interface HttpBodySerializerMap {
    [contentType: MimeType[number] | "default"]: HttpBodySerializer<never>
}

const DEFAULT_BODY_SERIALIZERS: HttpBodySerializerMap = {
...
export function serializeHttpResponse(bodySerializerMap?: HttpBodySerializerMap) {
    ...
    return (response: HttpResponse): SerializedHttpResponse => {
        ...
        const bodySerializer = bodySerializers[contentType];
        return {
            ...response,
